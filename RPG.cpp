...
/**
 * @brief Assigned values to default constructor values
*/
RPG::RPG(){
    name = "NPC";
    health = 100;
...
/**
*@brief Assigns private variables to the parameters and also calls setSkills()
*/
...
/**
 * @brief Implented accessor functions
*/
